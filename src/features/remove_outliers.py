...
#we can assume that for Accelerometer, data is somewhat Normally distributed except for rest label
#for Gyroscpe data is approximately Normally Distributed

#insert chauvenet function
...
#choose the method and deal with the outliers
