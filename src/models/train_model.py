...
#Gride Search for best hyperparameter and model selection
...
# Select Best model(NN with Feature Set 4) and evaluate result
...
"""
In this step we will create a new data set train and test,
training set wont contain the participant A data, 
with this we will again train NN  
"""
...
#lets try NN model with Selected_Features
(
    class_train_y,
    class_test_y,
    class_train_prob_y,
